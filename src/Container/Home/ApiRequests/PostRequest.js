...
export default function PostRequest({ showModal, setShowModal }) {
    ...
    const handleRequest = () => {
        ...
        url && postBody ? Api.PostRequest(url,postBody,OnSuccess,OnError) : console.error("Please enter url and body");
    }
  return (
    <CustModal
      showModal={showModal}
